...
import { TraineeReportsDashboardComponent } from 'src/app/modules/trainee-reports/components/trainee-reports-dashboard/trainee-reports-dashboard.component';
...
const routes: Routes = [
  { path: 'reports',
    ...
    children: [
      ...
      {
        path: 'weight-monitor',
        component: TrWeightMonitorComponent
      },
      {
        path: '',
        component: TrFoodChartComponent
